...
public class VendingMachineTest {
    ...
    public void testBuyItemWithExactPrice() {
        ...
        long price = vm.selectItemAndPrice(Item.COKE); 
    ...
    public void testBuyItemWithMorePrice(){
        long price = vm.selectItemAndPrice(Item.SODA);
    ...
    public void testRefund(){
        long price = vm.selectItemAndPrice(Item.PEPSI);
    ...
    public void testSoldOut(){
        for (int i = 0; i < 5; i++) {
            vm.selectItemAndPrice(Item.COKE);
            vm.insertCoin(Coin.QUARTER);
    ...
    public void testNotSufficientChangeException(){
        for (int i = 0; i < 5; i++) {
            vm.selectItemAndPrice(Item.SODA);
            vm.insertCoin(Coin.QUARTER);
            vm.insertCoin(Coin.QUARTER);
            vm.collectItemAndChange();
           
            vm.selectItemAndPrice(Item.PEPSI);
            vm.insertCoin(Coin.QUARTER);
            vm.insertCoin(Coin.QUARTER);
            vm.collectItemAndChange();
        }
    ...
    public void testReset(){
        ...
        vmachine.selectItemAndPrice(Item.COKE);
       
    }
   
    @Ignore
    public void testVendingMachineImpl(){
        VendingMachineIml vm = new VendingMachineIml();
    }
